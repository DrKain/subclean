...
var SubClean = /** @class */ (function () {
    ...
    SubClean.prototype.fixEncoding = function (item) {
        ...
        return new Promise(function (resolve) {
            try {
                ...
                if (!item.testing) {
                    fs_1.writeFileSync(input, data, { encoding: encoding });
                }
                resolve(true);
            }
            catch (error) {
    ...
    SubClean.prototype.cleanFile = function (item) {
        ...
        return new Promise(function (done, reject) { return __awaiter(_this, void 0, void 0, function () {
            var _a, encoding, language, alang, fileData, nodes_1, hits_1, codes, _i, _b, c, _c, codes_1, code, filter, deleted_nodes_1, cleaned, error_2;
            var _this = this;
