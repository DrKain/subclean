...
var SubClean = /** @class */ (function () {
    ...
    SubClean.prototype.fixEncoding = function (item) {
        var _this = this;
        var input = item.input, encoding = item.encoding;
        return new Promise(function (resolve) {
            try {
                var data = fs_1.readFileSync(input);
                if (item.testing === false) {
                    _this.saveFile("" + data, input, encoding);
                }
                resolve(true);
            }
            catch (error) {
    ...
    SubClean.prototype.readFile = function (target, encoding) {
        ...
        return new Promise(function (resolve) {
            try {
                var data = fs_1.readFileSync(target, { encoding: encoding });
                resolve(data);
            }
            catch (error) {
                _this.log(error);
    ...
    SubClean.prototype.clean = function (item, text) {
        ...
        return new Promise(function (done, reject) { return __awaiter(_this, void 0, void 0, function () {
            var fileData, _a, encoding, language, alang, nodes_1, hits_1, codes, _i, _b, c, _c, codes_1, code, filter, deleted_nodes_1, cleaned, ll, error_2;
            var _this = this;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _d.trys.push([0, 6, , 7]);
                        fileData = void 0;
                        if (!(text == undefined)) return [3 /*break*/, 4];
                    ...
                    case 1:
                        ...
                        if (!(encoding !== item.encoding && item.encodefile !== 'never')) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.fixEncoding(item)];
                    case 2:
                        _d.sent();
                    ...
                    case 3:
                        ...
                        fileData = fs_1.readFileSync(item.input, { encoding: item.encoding });
                        return [3 /*break*/, 5];
                    case 4:
                        fileData = text;
                        _d.label = 5;
    ...
    SubClean.prototype.saveFile = function (data, location, e) {
        var _this = this;
        if (e === void 0) { e = 'utf-8'; }
                ...
                try {
                    if (this.noFileOutput === false) {
                        if (this.args.testing === false) {
                            ...
                            fs_1.writeFileSync(location, data, { encoding: e });
                        }
                    }
                    resolve(true);
                }
...
if (require.main === module) {
    ...
    exports.subclean.logtofile = false;
}
